...
(function () {
  ...
  describe('MagicSearchController', function () {
    ...
    beforeEach(module('horizon.framework.widgets.legacy-magic-search'));
    beforeEach(inject(function($controller, _$timeout_, $window, $rootScope, $injector) {
      $timeout = _$timeout_;
      scope = $rootScope.$new();
      scope.strings = { prompt: "Hello World!" };
      scope.facets_param = [];
      service = $injector.get('horizon.framework.widgets.legacy-magic-search.service');
  ...
  describe('MagicSearch module', function () {
    it('should be defined', function () {
      expect(angular.module('horizon.framework.widgets.legacy-magic-search')).toBeDefined();
    });
  });
