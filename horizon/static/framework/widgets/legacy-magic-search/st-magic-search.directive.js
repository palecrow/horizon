...
(function () {
  ...
  function stMagicSearch($timeout) {
    ...
    function link(scope, element, attr, tableCtrl) {
      ...
      var textSearchWatcher = scope.$on('textSearch-rebroadcast', function(event, text) {
      ...
      var searchUpdatedWatcher = scope.$on('searchUpdated-rebroadcast', function(event, query) {
