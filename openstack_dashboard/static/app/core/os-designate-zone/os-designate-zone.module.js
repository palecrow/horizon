...
(function() {
  ...
  function run(registry, designate, zoneResourceType) {
    registry.setSlug('zone', zoneResourceType).getResourceType(zoneResourceType)
      .setNames(gettext('Zone'), gettext('Zones'))
