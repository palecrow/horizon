...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.app.core.os-designate-zone.actions
   *
   * @description
   * Provides all of the actions for DNS Zones.
   */
  angular.module('horizon.app.core.os-designate-zone.actions',
