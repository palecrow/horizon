...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.app.core.os-designate-recordset.details
   *
   * @description
   * Provides details features for instances.
   */
  angular.module('horizon.app.core.os-designate-recordset.details',
  ...
  run.$inject = [
    ...
    'horizon.app.core.os-designate-recordset.basePath',
...
//      .setDrawerTemplateUrl(basePath + 'details/drawer.html');
    ...
    resourceType.detailsViews
      .append({
        id: 'dnsRecordSetDetailsOverview',
        name: gettext('Overview'),
        template: basePath + 'details/overview.html'
      });

    function loadFunction(identifier) {
      return designateApi.getRecordSet(identifier);
    }
  }
